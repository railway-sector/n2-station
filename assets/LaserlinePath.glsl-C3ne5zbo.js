import{Kr as be,Kn as we,KJ as De,Ir as f,JD as w,Kw as Ve,Is as B,Io as r,c2 as q,xW as ee,Kq as xe,Jh as E,d6 as te,d4 as A,hq as F,KK as Le,hS as ie,JB as ne,IV as S,g8 as _,d3 as v,KL as se,Aj as ae,n as o,mK as re,hp as ye,s2 as Ee,d7 as Se,di as le,fk as oe,hn as Ce,Ko as Me,y8 as Ae,IT as $e,JL as Re,In as H,ce as Te,r7 as ce,r9 as he,_ as de,ga as Ie,c5 as K,qC as j,ak as c,an as z,jY as pe,gb as ue,d1 as Oe,d5 as O,lR as Ue,J4 as je,lT as qe,KM as ze,ID as V,oo as Ne,op as G,KN as We,mI as Be,KO as $,KP as Fe,wZ as J,r_ as He,vI as Ke,r$ as Ge,s0 as Je,s1 as ke,s3 as Qe,am as C,KQ as Xe,c7 as k}from"./index-DGFx_vCw.js";import{t as Ze}from"./VisualElement-DUiDIhmM.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new E("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new E("pointDistanceSphere",(i,s)=>Ye(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
