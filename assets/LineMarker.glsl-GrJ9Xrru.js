import{x0 as ee,IP as te,IQ as ie,Hm as re,Hk as ae,IR as se,IS as oe,Hp as o,II as ne,HZ as ce,IH as le,Ho as _,IT as pe,IU as de,I1 as N,Hn as he,Hq as ve,Hr as ue,Im as me,Ht as fe,IV as E,IW as R,IX as ge,IY as Se,I2 as Pe,k6 as ye,Hv as we,k8 as _e,Hw as ze,_ as xe,Hx as I,Hy as j,Hz as $e,HA as U,HB as L,I4 as be,HD as Te,HE as ke,HF as Ve,HH as k,HI as Oe,IZ as De,I_ as B,I$ as J,J0 as We,J1 as Ce,J2 as Ie,ag as c,al as Le,HJ as Me,HK as d,gz as He,I5 as Ae,J3 as q,rI as Fe,Iy as Ne,J4 as Ee,HN as Re,dy as Y,lb as je,gT as K,K as Q,J5 as Ue}from"./index-D9orNzXX.js";function Z(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(R),S.constants.add("relativeMarkerSize","float",ge/E).constants.add("relativeTipLineWidth","float",Se).code.add(o`
