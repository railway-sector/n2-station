import{xB as te,Ih as ie,Ii as re,GU as ae,Ij as se,Ik as oe,GY as o,Ia as ne,Hr as ce,I9 as le,GX as y,Il as pe,Im as de,Hv as N,GW as he,GZ as ve,G_ as ue,HR as me,H0 as fe,In as R,Io as U,Ip as Se,Iq as ge,Hw as Pe,g5 as ye,qO as _e,jS as we,qQ as xe,_ as ze,qS as D,H2 as E,H3 as $e,H4 as q,qT as I,H6 as be,H7 as ke,H9 as Ve,Ir as Oe,Is as B,It as G,Iu as Te,Iv as We,Iw as Ce,ae as d,ah as De,Hy as Me,Hb as m,fH as Ie,Hd as M,HB as Le,Ix as Y,t4 as je,I1 as He,Iy as Ae,He as Fe,c$ as Q,kH as Ne,g2 as X,n as Z,Iz as Re}from"./index-N1EZ-Qhr.js";function J(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:g,varyings:S}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),S.add("vColor","vec4"),S.add("vpos","vec3",{invariant:!0}),S.add("vUV","vec2"),S.add("vSize","float"),_&&S.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
